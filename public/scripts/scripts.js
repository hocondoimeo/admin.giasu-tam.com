...
function loadModal(content){
	var html = '<div id="loadModal" class="modal fade modal-white" role="dialog" tabindex="-1">';
	...
	$('#loadModal').one('show.bs.modal',  function (e) {
		$(".page-wrap").css("-webkit-filter", "blur(1px) grayscale(50%)");
		$(".page-wrap").css("-webkit-transform", "scale(1)");
    }).one('hide.bs.modal',  function (e) {
		$(".page-wrap").css("cssText", "transition:all 0.2s ease !important");
    }).modal('show');
}
